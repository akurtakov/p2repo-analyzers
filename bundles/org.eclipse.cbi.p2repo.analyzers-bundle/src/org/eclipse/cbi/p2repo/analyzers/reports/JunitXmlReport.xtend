...
class JunitXmlReport implements ICheckReporter {
	...
	override void createReport(CheckReportsManager manager, IP2RepositoryAnalyserConfiguration configs) {
		...
		val xmlContent = '''
			...
			<testrun name="Simrel report" project="org.eclipse.cbi.p2repo.analyzers-bundle" tests="«manager.reports.size»" started="«manager.reports.size»" failures="0" errors="0" ignored="0">
